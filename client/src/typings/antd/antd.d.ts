...
declare namespace Antd {
    ...
    */
    ...
    export class FormComponent<P extends FormComponentProps, S> extends React.Component<P, S> {
        render(): JSX.Element
    }
    ...
    type CreateFormOptions = {
        ...
        getFieldProps<T>(name?:string,options?:Object):T;
    ...
    */
    ...
    interface SelectProps {
        ...
        /** 输入框自动提示模式*/
        combobox?: SVGSymbolElement|boolean,
